        ...
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex flex-col md:px-[20px] relative w-[100%]">
            <div className="flex flex-col items-start justify-start mx-[auto] pb-[69px] w-[100%]">
              ...
              <div className="bg-gray_51 border-black_900 border-solid border-t-[1px] font-roboto sm:h-[1530px] md:h-[353px] h-[361px] md:ml-[0] ml-[168px] relative md:w-[100%] w-[92%]">
                <div className="absolute bg-gray_51 border-black_900 border-solid border-t-[1px] h-[353px] inset-y-[0] left-[0] my-[auto] w-[94%]"></div>
              ...
              <div className="border-b-[1px] border-black_900 border-solid flex flex-col font-inter items-start justify-start mt-[2px] p-[64px] sm:px-[20px] md:px-[40px] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_900 border-solid flex font-inter items-center justify-start mt-[38px] pb-[16px] px-[16px] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_900 border-solid flex md:flex-col flex-row font-inter md:gap-[40px] items-start justify-between mt-[80px] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_900 border-solid flex font-inter items-center justify-start mt-[23px] w-[100%]">
                <List
            ...
            <div className="bg-bluegray_908 flex items-center justify-center mt-[-42.25px] mx-[auto] p-[22px] sm:px-[20px] rounded-[16px] w-[99%] z-[1]">
