...
const MyProfileHistoryPage: React.FC = () => {
  const tableData2 = React.useRef<TableRowType2[]>([
    {
  ...
  const columnHelper2 = createColumnHelper<TableRowType2>();
  const column2 = [
                  ...
                  <div className="flex flex-col gap-[8px] items-center justify-start w-[100%]">
                    ...
                    <div className="bg-gray_900_5f flex font-outfit items-start justify-end p-[8px] rounded-[10px] w-[100%]">
                      <div className="flex flex-row gap-[18px] items-start justify-start md:ml-[0] ml-[7px] mr-[auto] md:w-[100%] w-[41%]">
                        <Img
                          src="images/img_clock_gray_920.svg"
                          className="h-[24px] w-[24px]"
                          alt="clock Two"
                        />
                        <Text
        ...
        <div className="flex flex-1 flex-col gap-[39px] items-center justify-end md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-col font-urbanist items-start justify-start md:w-[100%] w-[95%]">
            ...
            <div className="flex sm:flex-col flex-row sm:gap-[20px] items-center justify-start mt-[17px] w-[100%]">
              ...
              <Button
                className="flex items-center justify-center ml-[497px] outline outline-[0.5px] outline-gray_106 pl-[16px] pr-[17px] py-[16px] rounded-[14px] sm:ml-[0] text-center"
                leftIcon={
                  <Img
            ...
            <div className="overflow-auto bg-white_A700 mt-[30px] outline outline-[0.5px] outline-gray_106 rounded-[15px] shadow-bs21 w-[100%]">
              <ReactTable
                columns={column2}
