...
import { Text, Img, List, Input, Button, SelectBox } from "components";
...
const MarketPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray_919 font-outfit h-[1312px] mx-[auto] pb-[18px] pr-[18px] relative w-[100%]">
        <div className="absolute bg-gray_55 border-[1px] border-gray_106 border-solid flex flex-col gap-[50px] items-start justify-start left-[0] md:px-[20px] py-[34px] top-[0] w-[21%]">
          ...
          <div className="flex flex-col font-urbanist gap-[30px] items-center justify-start px-[18px] w-[100%]">
            <div className="flex flex-col gap-[13px] justify-start w-[100%]">
              ...
              <div className="flex flex-col gap-[8px] items-center justify-start w-[100%]">
                ...
                >
                  <div className="flex flex-1 items-start justify-end p-[8px] w-[100%]">
            ...
            <div className="flex flex-col gap-[13px] justify-start w-[100%]">
              ...
              <div className="flex flex-col font-outfit gap-[8px] items-center justify-start w-[100%]">
                <Input
                  className="font-medium p-[0] text-[18px] placeholder:text-gray_920 text-gray_920 text-left tracking-[0.18px] w-[100%]"
                  wrapClassName="bg-gray_900_5f flex pl-[16px] pr-[35px] py-[10px] rounded-[10px] sm:pr-[20px] w-[100%]"
                  name="Menu"
                  placeholder="Market"
                  prefix={
                    <Img
            ...
            <div className="flex flex-col gap-[13px] justify-start w-[100%]">
              ...
              <div className="flex flex-col gap-[8px] items-center justify-start w-[100%]">
                <List
                  ...
                  orientation="vertical"
                >
                  <div className="flex flex-1 items-start justify-start my-[0] p-[10px] w-[100%]">
                    <div className="flex flex-row gap-[18px] items-center justify-start md:ml-[0] ml-[6px] pr-[3px] md:w-[100%] w-[51%]">
                      <Img
        ...
        <div className="absolute flex flex-col gap-[35px] h-[max-content] inset-y-[0] items-center justify-start my-[auto] md:px-[20px] right-[1%] w-[80%]">
          <header className="flex items-center justify-center w-[100%]">
            <div className="bg-white_A700 flex md:flex-col flex-row md:gap-[40px] items-center justify-between outline outline-[0.5px] outline-gray_106 p-[34px] sm:px-[20px] w-[100%]">
              <Input
                ...
                wrapClassName="bg-white_A700 border-[1px] border-gray_310 border-solid flex md:mt-[0] md:w-[100%] my-[2px] pl-[16px] pr-[35px] py-[16px] rounded-[15px] sm:pr-[20px] sm:w-[100%] w-[45%]"
                name="SearchInput"
              ...
              ></Input>
              <ul className="flex md:flex-1 flex-row font-urbanist gap-[30px] sm:hidden items-center justify-center md:mt-[0] my-[2px] md:w-[100%] w-[32%] common-row-list">
                ...
                <li className="ml-[30px] sm:w-[100%] sm:my-[10px] w-[16%]">
                  <Button className="flex h-[52px] items-center justify-center outline outline-[0.5px] outline-gray_106 p-[14px] rounded-[50%]">
                    <Img
                ...
                <li className="ml-[30px] sm:w-[100%] sm:my-[10px] sm:mx-[0] w-[27%]">
                  <SelectBox
                    className=""
          ...
          <div className="flex flex-col font-urbanist gap-[21px] items-start justify-start md:w-[100%] w-[95%]">
            ...
            <div className="flex flex-col items-center justify-start md:ml-[0] ml-[2px] w-[100%]">
              ...
              <Button className="cursor-pointer font-normal min-w-[106px] mt-[50px] not-italic outline outline-[0.5px] outline-gray_920 py-[8px] rounded-[8px] text-[14px] text-center text-gray_920 tracking-[0.14px] w-[auto]">
                Load More
              </Button>
            </div>
          </div>
