...
const FaphousecombyhtmltodesignFREEversion03032023Page: React.FC = () => {
        ...
        <div className="flex flex-col items-center justify-start max-w-[1600px] mx-[auto] w-[100%]">
          ...
          <div className="bg-black_902 border-b-[1px] border-gray_712 border-solid flex items-start justify-start md:w-[100%] w-[auto]">
            <div className="h-[387px] pb-[64px] pl-[20px] sm:pr-[20px] md:pr-[40px] pr-[930px] pt-[40px] relative md:w-[100%] w-[1600px]">
              <div className="absolute bg-gradient30  h-[387px] inset-y-[0] left-[5%] my-[auto] w-[19%]"></div>
          ...
          <div className="bg-black_902 flex items-start justify-start pb-[24px] pt-[32px] px-[20px] md:w-[100%] w-[auto]">
          ...
          <div className="bg-black_902 border-gray_712 border-solid border-t-[1px] flex items-start justify-start pb-[34px] pt-[27px] px-[20px] md:w-[100%] w-[auto]">
            <div className="flex md:flex-col flex-row md:gap-[40px] items-end justify-between w-[100%]">
              ...
              <div className="flex sm:flex-1 flex-row gap-[11.34px] items-center justify-start pr-[179.66px] sm:pr-[20px] md:pr-[40px] sm:w-[100%] w-[auto]">
                ...
                <Img
                  src="images/img_twitter_bluegray_303.svg"
