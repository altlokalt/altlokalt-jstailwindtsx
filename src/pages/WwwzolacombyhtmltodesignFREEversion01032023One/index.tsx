...
const WwwzolacombyhtmltodesignFREEversion01032023OnePage: React.FC = () => {
  return (
    <>
      <div className="bg-white_A700 flex font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="bg-gray_102 flex flex-col gap-[44px] justify-start pt-[40px] sm:px-[20px] px-[40px] w-[100%]">
            <div className="flex md:flex-col flex-row gap-[20px] items-start justify-start md:ml-[0] ml-[220px] pt-[4px] md:px-[20px] md:w-[100%] w-[auto]">
              <Input
            ...
            <div className="flex flex-col items-center justify-start max-w-[1420px] mx-[auto] md:px-[20px] w-[100%]">
              <div className="bg-gray_102 flex items-center justify-start pb-[20px] w-[100%]">
                <div className="flex flex-col items-center justify-start w-[100%]">
                  <div className="flex sm:flex-col flex-row md:gap-[40px] items-center justify-between md:w-[100%] w-[99%]">
                    <Text
                      className="capitalize font-normal not-italic text-gray_800 text-left w-[auto]"
                      variant="body56"
                    >
                    ...
                    <div className="flex flex-row gap-[10.13px] items-start justify-start w-[auto]">
                      ...
                      <div className="flex items-start justify-start sm:w-[100%] w-[auto]">
                        <SelectBox
                          className="bg-white_A700 border-[1px] border-gray_306 border-solid font-normal leading-[normal] not-italic pl-[13px] sm:pr-[20px] pr-[33px] py-[12.5px] rounded-[4px] text-[14px] text-black_900 text-left w-[100%]"
                  ...
                  <div className="flex items-center justify-start mt-[10px] p-[10px] w-[100%]">
                    <div className="flex flex-col gap-[40px] items-center justify-start mb-[20px] w-[100%]">
                      <div className="gap-[20px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 justify-center min-h-[auto] w-[100%]">
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_ef573075716e4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="ef573075716eFour"
                                    />
                                    <PagerIndicator
                                    ...
                                    <Img
                                      ...
                                      alt="arrowdown Three"
                                    />
                                    <Button className="absolute bg-white_A700 cursor-pointer font-normal left-[2%] min-w-[104px] not-italic pl-[8px] pr-[10.77px] rounded-[4px] shadow-bs10 text-[11px] text-black_900 text-center top-[4%] w-[auto]">
                                      Quick responder
                                    </Button>
                                  </div>
                                </div>
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[10.11px] sm:pr-[20px] pr-[217.89px] md:pr-[40px] w-[auto]">
                              <Text
                            ...
                            <Text
                              className="font-semibold text-gray_904 text-left w-[auto]"
                              variant="body61"
                            >
                              NY Wedding DJ
                            </Text>
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_08045bfb09254.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="08045bfb09254"
                                    />
                                    <PagerIndicator
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[7.86px] pr-[192.14px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body82"
                              >
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_71632bbd8c654.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="71632bbd8c654"
                                    />
                                    <PagerIndicator
                          ...
                          <div className="flex flex-col gap-[9px] justify-start py-[14px] w-[100%]">
                            <Text
                              className="font-normal md:ml-[0] ml-[17px] not-italic text-gray_602 text-left w-[auto]"
                              variant="body82"
                            >
                              New York, NY
                            </Text>
                            <div className="flex flex-col gap-[14px] items-start justify-start mb-[11px] w-[100%]">
                              <Text
                                className="font-semibold text-gray_904 text-left w-[auto]"
                                variant="body61"
                              >
                              ...
                              <div className="flex flex-row gap-[4px] items-center justify-start pr-[178px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                                <Img
                                  src="images/img_thumbsup.svg"
                                  className="h-[16px] w-[16px]"
                                  alt="thumbsup Two"
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_c3f5bea093b44.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="c3f5bea093bFortyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[8.33px] pr-[156.67px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_b274f8a84e574.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="b274f8a84e574"
                                    />
                                    <PagerIndicator
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_6b42f5a7ba1e4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="6b42f5a7ba1eFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[8.52px] pr-[131.48px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                                Band or Ensemble • New York, NY
                              </Text>
                            </div>
                            <Text
                              className="font-semibold text-gray_904 text-left w-[auto]"
                            ...
                            <div className="flex flex-col gap-[8px] items-start justify-start w-[auto]">
                              ...
                              <div className="flex flex-row gap-[4px] items-center justify-start pr-[177px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                                <Img
                                  src="images/img_thumbsup.svg"
                                  className="h-[16px] w-[16px]"
                                  alt="thumbsup Five"
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                          <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                            <div className="flex items-start justify-start w-[auto]">
                              <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                <Img
                                  src="images/img_7fcf942f3a734.png"
                                  className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                  alt="7fcf942f3a734"
                                />
                                <Img
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[9.33px] pr-[157.67px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                          <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                            <div className="flex items-start justify-start w-[auto]">
                              <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                <Img
                                  src="images/img_c3d333e484654.png"
                                  className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                  alt="c3d333e484654"
                                />
                                <Img
                                ...
                                />
                                <Button
                                  className="absolute bg-deep_purple_100 flex items-center justify-center left-[2%] min-w-[99px] px-[8px] py-[5px] rounded-[4px] shadow-bs10 text-center top-[4%] w-[auto]"
                                  leftIcon={
                                    <Img
                                ...
                                >
                                  <div className="bg-transparent cursor-pointer font-normal not-italic text-[11px] text-left text-pink_900">
                                    Hidden gem
                                  </div>
                                </Button>
                              </div>
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[8.52px] pr-[202.48px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                          <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                            <div className="flex items-start justify-start w-[auto]">
                              <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                <Img
                                  src="images/img_7671c2afd9784_224x335.png"
                                  className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                  alt="7671c2afd9784"
                                />
                                <Img
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_89ee1c36b1a04.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="89ee1c36b1aFour"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_b19792a5b8784.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="b19792a5b8784"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_f04e3a4432774.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="f04e3a4432774"
                                    />
                                    <PagerIndicator
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_2420671d77244.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="2420671d77244"
                                    />
                                    <PagerIndicator
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[22px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[8.33px] pr-[191.67px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_deda34f469d14.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="deda34f469dFourteen"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[8.52px] pr-[122.48px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                                beauty professional • New York, NY
                              </Text>
                            </div>
                            <Text
                              className="font-semibold text-gray_904 text-left w-[auto]"
                            ...
                            <div className="flex flex-col items-start justify-start w-[100%]">
                              ...
                              <Text
                                className="font-normal mt-[7px] not-italic text-gray_904 text-left w-[auto]"
                                variant="body87"
                              >
                                Starts at $400
                              </Text>
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_dfa110c3beb24.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="dfa110c3bebTwentyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_6deda7261f744.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="6deda7261f744"
                                    />
                                    <PagerIndicator
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pt-[12px] w-[auto]">
                            ...
                            <div className="flex flex-col items-start justify-start w-[100%]">
                              ...
                              <Text
                                className="font-normal mt-[5px] not-italic text-gray_904 text-left w-[auto]"
                                variant="body87"
                              >
                                Starts at $45,000
                              </Text>
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_a26d4b83c0a94.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="a26d4b83c0aNinetyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[22px] pt-[12px] w-[auto]">
                            ...
                            <div className="flex flex-col gap-[8px] items-start justify-start w-[auto]">
                              ...
                              <div className="flex flex-row gap-[4px] items-center justify-start pr-[179px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                                <Img
                                  src="images/img_thumbsup.svg"
                                  className="h-[16px] w-[16px]"
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_08040ac37a424.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="08040ac37a424"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_ae38414ee91e4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="ae38414ee91eFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                          <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                            <div className="flex items-start justify-start w-[auto]">
                              <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                <Img
                                  src="images/img_5ad6be74e4fc4_224x335.png"
                                  className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                          ...
                          <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                            ...
                            <Text
                              className="font-semibold mt-[10px] text-gray_904 text-left w-[auto]"
                              variant="body61"
                            >
                              New York Wedding Films
                            </Text>
                            <div className="flex flex-row gap-[4px] items-center justify-start my-[14px] pr-[186px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Img
                                src="images/img_thumbsup.svg"
                                className="h-[16px] w-[16px]"
                                alt="thumbsup Twenty"
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_e0e57d438ce74.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="e0e57d438ceSeventyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                            ...
                            <div className="flex flex-row gap-[4px] items-center justify-start my-[14px] pr-[195px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Img
                                src="images/img_thumbsup.svg"
                                className="h-[16px] w-[16px]"
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_2c357e7301da4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="2c357e7301daFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                            ...
                            <Text
                              className="font-semibold mt-[11px] text-gray_904 text-left w-[auto]"
                              variant="body64"
                            >
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_3032662699f04.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="3032662699fFour"
                                    />
                                    <PagerIndicator
                          ...
                          <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                            <div className="flex items-start justify-start pl-[10.45px] pr-[191.55px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                              >
                            ...
                            <Text
                              className="font-semibold mt-[9px] text-gray_904 text-left w-[auto]"
                              variant="body64"
                            >
                              Scoozi Events
                            </Text>
                            <div className="flex flex-row gap-[4px] items-center justify-start my-[15px] pr-[195px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Img
                                src="images/img_thumbsup.svg"
                                className="h-[16px] w-[16px]"
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_2120ada948db4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="2120ada948dbFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_799a6890e5a64.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="799a6890e5aSixtyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                            ...
                            <div className="flex flex-row gap-[4px] items-center justify-start my-[15px] pr-[185px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Img
                                src="images/img_thumbsup.svg"
                                className="h-[16px] w-[16px]"
                                alt="thumbsup TwentyFive"
                              />
                              <Text
                                className="font-semibold text-gray_904 text-left w-[auto]"
                                variant="body82"
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_d97436369cb64.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="d97436369cbSixtyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                            ...
                            <div className="flex flex-row gap-[4px] items-center justify-start my-[14px] pr-[185px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Img
                                src="images/img_thumbsup.svg"
                                className="h-[16px] w-[16px]"
                                alt="thumbsup TwentySix"
                              />
                              <Text
                                className="font-semibold text-gray_904 text-left w-[auto]"
                                variant="body82"
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_1b7275d3dcb84.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="1b7275d3dcbEightyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_2b989c796f4f4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="2b989c796f4fFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={4}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[60px] pt-[12px] w-[auto]">
                            <div className="flex items-start justify-start pl-[8.52px] pr-[122.48px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_602 text-left w-[auto]"
                                variant="body87"
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_ef9e38c512374.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="ef9e38c512374"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_27a50533354e4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="27a50533354eFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_087be8fd67cd4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="087be8fd67cdFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pt-[12px] w-[auto]">
                            ...
                            <Text
                              className="font-semibold leading-[24.00px] md:max-w-[100%] max-w-[323px] text-gray_904 text-left"
                              variant="body60"
                            >
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_779975d75c2a4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="779975d75c2aFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[46px] pt-[12px] w-[auto]">
                            ...
                            <div className="flex flex-col gap-[8px] items-start justify-start w-[auto]">
                              ...
                              <div className="flex flex-row gap-[4px] items-center justify-start pr-[180px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                                <Img
                                  src="images/img_thumbsup.svg"
                                  className="h-[16px] w-[16px]"
                                  alt="thumbsup ThirtyOne"
                                />
                                <Text
                                  className="font-semibold text-gray_904 text-left w-[auto]"
                                  variant="body82"
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_81e6966cd4904.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="81e6966cd4904"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_fc26e15f53264.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="fc26e15f53264"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_3f6979b994374.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="3f6979b994374"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_f1f3418956ef4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="f1f3418956efFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_1055c4f516e34.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="1055c4f516eThirtyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_028466c2654e4.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="028466c2654eFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                          ...
                          <div className="flex flex-col gap-[8px] items-start justify-start pb-[8px] pt-[12px] w-[auto]">
                            ...
                            <Text
                              ...
                              variant="body61"
                            >
                              Meredith Morris Photography LLC
                            </Text>
                            <div className="flex flex-col gap-[8px] items-start justify-start w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_904 text-left w-[auto]"
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_1e0809e3ae354.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="1e0809e3ae354"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_706b2b523df84.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="706b2b523dfEightyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_d06444680fa04.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="d06444680faFour"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_f6c26b985c994.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="f6c26b985c994"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_4e532f9d1b454.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="4e532f9d1b454"
                                    />
                                    <PagerIndicator
                            ...
                            <div className="flex items-center justify-start w-[100%]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                  <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                    <Img
                                      src="images/img_6defe82c57b24.png"
                                      className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                      alt="6defe82c57bTwentyFour"
                                    />
                                    <PagerIndicator
                                      className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                      count={5}
                      ...
                      >
                        <div className="flex-1 gap-[20px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-between w-[100%]">
                          <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                  <Img
                                    src="images/img_50b5a72812634.png"
                                    className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                    alt="50b5a72812634"
                                  />
                                  <Img
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_05565e861c354.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="05565e861c354"
                                      />
                                      <PagerIndicator
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_3b7d4bae6f5f4.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                          ...
                          <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                  <Img
                                    src="images/img_ccbaa57d80744.png"
                                    className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                    alt="ccbaa57d80744"
                                  />
                                  <Img
                          ...
                          <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                  <Img
                                    src="images/img_e80a547eb4f24.png"
                                    className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                    alt="e80a547eb4fTwentyFour"
                                  />
                                  <Img
                                    src="images/img_arrowdown.svg"
                                    className="absolute h-[44px] right-[0] top-[0] w-[44px]"
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_0cdb24db116c4.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="0cdb24db116cFour"
                                      />
                                      <PagerIndicator
                                        className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                        count={5}
                                      ...
                                      />
                                      <Button
                                        className="absolute bg-cyan_A100 flex items-center justify-center left-[2%] min-w-[80px] px-[8px] py-[5px] rounded-[4px] shadow-bs10 text-center top-[4%] w-[auto]"
                                        leftIcon={
                                          <Img
                                      ...
                                      >
                                        <div className="bg-transparent cursor-pointer font-normal not-italic text-[11px] text-bluegray_908 text-left">
                                          Trending
                                        </div>
                                      </Button>
                                    </div>
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_4483b4410aa14.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="4483b4410aaFourteen"
                                      />
                                      <PagerIndicator
                                        className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                        count={5}
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_f8c35a1ff2404.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="f8c35a1ff2404"
                                      />
                                      <PagerIndicator
                        ...
                        <div className="flex-1 gap-[20px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-between w-[100%]">
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_ca235ed5e2a44.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="ca235ed5e2aFortyFour"
                                      />
                                      <PagerIndicator
                                        className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                        count={5}
                          ...
                          <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_695024a0518b4.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="695024a0518bFour"
                                      />
                                      <PagerIndicator
                                        className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                        count={5}
                            ...
                            <div className="flex flex-col items-start justify-start py-[12px] w-[100%]">
                              ...
                              <Text
                                className="font-semibold mt-[8px] text-gray_904 text-left w-[auto]"
                                variant="body61"
                              >
                                Koat Floral
                              </Text>
                              <div className="flex flex-row gap-[4px] items-center justify-start my-[15px] pr-[186px] sm:pr-[20px] md:pr-[40px] w-[auto]">
                                <Img
                                  src="images/img_thumbsup.svg"
                                  className="h-[16px] w-[16px]"
                                  alt="thumbsup FortyThree"
                                />
                                <Text
                                  className="font-semibold text-gray_904 text-left w-[auto]"
                                  variant="body82"
                          ...
                          <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                            <div className="flex items-start justify-start pb-[180.44px] sm:pl-[20px] pl-[291px] md:pl-[40px] w-[auto]">
                              <div className="flex items-start justify-start w-[auto]">
                                <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                  <Img
                                    src="images/img_cbb4638b86014.png"
                                    className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                    alt="cbb4638b86014"
                                  />
                                  <Img
                              ...
                              <div className="flex items-center justify-start w-[100%]">
                                <div className="flex items-start justify-start w-[auto]">
                                  <div className="flex items-start justify-start pb-[6.84px] w-[auto]">
                                    <div className="bg-gray_103 h-[224px] relative rounded-[4px] w-[100%]">
                                      <Img
                                        src="images/img_48fa14ee02aa4.png"
                                        className="h-[224px] m-[auto] object-cover rounded-[4px] w-[100%]"
                                        alt="48fa14ee02aaFour"
                                      />
                                      <PagerIndicator
                                        className="absolute bottom-[1%] flex h-[22px] inset-x-[0] justify-center mx-[auto] w-[1px]"
                                        count={5}
                  ...
                  <div className="bg-white_A700 flex md:flex-col flex-row md:gap-[40px] items-center justify-between rounded-[4px] md:w-[100%] w-[99%]">
                    <div className="flex sm:flex-col flex-row gap-[20px] items-center justify-start p-[20px] md:w-[100%] w-[44%]">
                      <div className="bg-teal_51 flex h-[85px] items-center justify-start sm:mt-[0] my-[7px] rounded-[42px] w-[85px]">
                        <Img
                    ...
                    <div className="bg-light_green_100 flex sm:flex-col flex-row gap-[20px] items-center justify-start sm:px-[20px] px-[30px] md:w-[100%] w-[34%]">
                      <div className="flex flex-col gap-[10.84px] items-start justify-start pb-[20.16px] pt-[19px] w-[auto]">
                        <Text
                          className="font-normal leading-[22.86px] md:max-w-[100%] max-w-[183px] not-italic text-black_900 text-left"
                          variant="body69"
                        >
                          While you’re here, start your save the dates
                        </Text>
                        <Button className="bg-black_900 cursor-pointer font-semibold min-w-[210px] pb-[11.42px] pl-[38.14px] pr-[39.86px] pt-[9.58px] sm:px-[20px] rounded-[22px] text-[16px] text-center text-white_A700 w-[auto]">
                          Get free samples
                        </Button>
                      </div>
                      <div className="md:h-[114px] h-[140px] pl-[45.07px] pr-[104.53px] sm:px-[20px] md:px-[40px] py-[12.6px] relative w-[180px]">
                        <div className="absolute bg-blue_700 h-[106px] inset-[0] justify-center m-[auto] rounded-[53px] w-[78%]"></div>
                        <div className="absolute bg-white_A700 flex h-[max-content] inset-[0] items-center justify-center m-[auto] rounded-[8px] shadow-bs12 w-[50%]">
                          <div className="h-[114px] relative w-[100%]">
                            ...
                            <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] w-[66%]">
                              <div className="flex flex-col items-center justify-start md:w-[100%] w-[52%]">
                                ...
                                />
                                <Text
                                  className="mt-[3px] not-italic text-center text-gray_703 tracking-[0.70px] w-[auto]"
                                  variant="body9"
                                >
                                  nicki and elizabeth
                                </Text>
                                <Text
                                  className="not-italic text-center text-gray_703 tracking-[1.30px] w-[auto]"
                                  variant="body89"
                                >
                                  SAVE THE DATE
                                </Text>
                              ...
                              <Img
                                src="images/img_div_59x58.png"
                                className="h-[59px] md:h-[auto] mt-[4px] object-cover rounded-[8px] sm:w-[100%] w-[58px]"
                                alt="div Four"
                              />
                              <Text
                                className="mt-[4px] not-italic text-center text-gray_703 tracking-[0.70px] w-[auto]"
                                variant="body9"
                              >
                                june 29, 2024 | san francisco, ca
                              </Text>
                              <Text
                                className="not-italic text-center text-gray_703 w-[auto]"
                                variant="body65"
                              >
                                invitation to come
                              </Text>
              ...
              <div className="flex flex-col gap-[20px] items-center justify-center w-[100%]">
                <div className="flex flex-col justify-end mt-[39px] w-[100%]">
                  <Text
                    className="font-medium md:ml-[0] ml-[9px] mr-[1007px] text-gray_904 text-left tracking-[0.20px] w-[auto]"
                    variant="body35"
                  >
                    Get Expert Vendor Advice
                  </Text>
                  <div className="h-[303px] md:h-[318px] mt-[15px] relative w-[100%]">
                    <div className="absolute flex h-[100%] inset-[0] items-center justify-center m-[auto] w-[99%]">
                      ...
                      >
                        <div className="flex flex-col gap-[12px] items-start justify-start sm:ml-[0] pb-[12px] w-[auto]">
                          <div className="bg-gray_104 flex items-center justify-start rounded-[4px] w-[100%]">
                            <Img
                              src="images/img_newyorkcityg.png"
                              className="h-[225px] md:h-[auto] object-cover rounded-[4px] w-[100%]"
                              alt="newyorkcityg"
                            />
                          </div>
                          <Text
                            className="capitalize font-semibold md:max-w-[100%] max-w-[300px] text-black_900 text-left"
                            variant="body60"
                          >
                            How to Get Married in New York City: A Complete
                            Guide
                          </Text>
                        </div>
                        <div className="flex flex-col gap-[12px] items-start justify-start mb-[24px] sm:ml-[0] pb-[13px] w-[auto]">
                          <div className="bg-gray_104 flex items-center justify-start rounded-[4px] w-[100%]">
                            <Img
                              src="images/img_lovesomephotographywebp.png"
                              className="h-[225px] md:h-[auto] object-cover rounded-[4px] w-[100%]"
                              alt="lovesomephotographywebp"
                            />
                          </div>
                          <Text
                        ...
                        <div className="flex flex-col gap-[12px] items-start justify-start sm:ml-[0] pb-[12px] w-[auto]">
                          <div className="bg-gray_104 flex items-center justify-start rounded-[4px] w-[100%]">
                            <Img
                              src="images/img_heronewphotobyepagafotojpg.png"
                              className="h-[225px] md:h-[auto] object-cover rounded-[4px] w-[100%]"
                              alt="HeroNewPhotoByepagaFOTOjpg"
                            />
                          </div>
                          <Text
                            className="capitalize font-semibold md:max-w-[100%] max-w-[336px] text-black_900 text-left"
                            variant="body60"
                          >
                        ...
                        <div className="flex flex-col gap-[13px] items-start justify-start sm:ml-[0] pb-[13px] w-[auto]">
                          <div className="bg-gray_104 flex items-center justify-start rounded-[4px] w-[100%]">
                            <Img
                              src="images/img_heronewjpg.png"
                              className="h-[225px] md:h-[auto] object-cover rounded-[4px] w-[100%]"
                              alt="HeroNewjpg"
                            />
                          </div>
                          <Text
                            className="capitalize font-semibold md:max-w-[100%] max-w-[258px] text-black_900 text-left"
                            variant="body61"
                          >
                    ...
                    <Img
                      ...
                      className="absolute h-[30px] right-[0] top-[32%] w-[30px]"
                      alt="clock"
                    />
                    <Img
                      src="images/img_checkmark.svg"
                      className="absolute h-[30px] left-[0] top-[32%] w-[30px]"
                      alt="checkmark"
                    />
                  </div>
                  <div className="flex flex-row items-start justify-start md:ml-[0] ml-[15px] mr-[9px] mt-[20px] md:w-[100%] w-[99%]">
                    <Text
                      className="capitalize font-semibold text-black_900 text-left w-[auto]"
                      variant="body61"
                    >
                ...
                <div className="flex flex-col items-start justify-end mb-[59px] pt-[60px] w-[100%]">
                  <Text
                    className="font-medium md:ml-[0] ml-[9px] text-gray_904 text-left tracking-[0.20px] w-[auto]"
                    variant="body35"
                  >
                  ...
                  <div className="h-[326px] md:h-[341px] mt-[15px] relative w-[100%]">
                    <div className="absolute flex h-[100%] inset-[0] items-center justify-center m-[auto] w-[99%]">
                      <List
                        ...
                        orientation="horizontal"
                      >
                        <div className="flex flex-1 flex-col items-center justify-start mb-[20px] sm:ml-[0] rounded-[4px] shadow-bs1 w-[100%]">
                          <Img
                            src="images/img_ccb316cdc1e24.png"
                          ...
                          <div className="flex flex-row gap-[64.85px] items-center justify-start px-[20px] py-[21.5px] w-[auto]">
                            <Text
                              className="font-semibold md:max-w-[100%] max-w-[161px] text-black_900 text-left"
                              variant="body82"
                            >
                              Classy Celebration at the Brooklyn Botanic Garden
                            </Text>
                            <Img
                        ...
                        <div className="flex flex-1 flex-col items-center justify-start mb-[20px] sm:ml-[0] rounded-[4px] shadow-bs1 w-[100%]">
                          ...
                          <div className="flex flex-row gap-[54.94px] items-center justify-start px-[20px] py-[20.5px] w-[auto]">
                            <Text
                              className="font-semibold md:max-w-[100%] max-w-[195px] text-black_900 text-left"
                              variant="body78"
                            >
          ...
          <div className="bg-white_A700 border-gray_600 border-solid border-t-[1px] flex items-center justify-end p-[30px] sm:px-[20px] w-[100%]">
            <div className="flex items-center justify-start max-w-[1180px] mx-[auto] md:px-[20px] w-[100%]">
              <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-evenly w-[100%]">
                <div className="flex md:flex-1 flex-col items-start justify-end pt-[15px] px-[15px] md:w-[100%] w-[42%]">
                  <Img
                    src="images/img_svg_bluegray_908.svg"
                    className="h-[20px] mt-[5px] w-[auto]"
                    alt="svg One"
                  />
                  <Text
                    className="font-normal mt-[16px] not-italic text-black_900 text-left w-[auto]"
                    variant="body78"
                  >
                    For all the days along the way
                  </Text>
                  <Text
                    className="font-semibold md:ml-[0] ml-[122px] mt-[25px] text-black_900 text-left tracking-[1.20px] w-[auto]"
                    variant="body91"
                  >
                    @ZOLA
                  </Text>
                  ...
                  <div className="flex items-start justify-start mt-[5px] w-[100%]">
                    <div className="flex flex-col items-center justify-start md:w-[100%] w-[57%]">
                      <div className="flex flex-row items-start justify-evenly w-[100%]">
                        <Text
                          className="capitalize font-normal mt-[5px] not-italic text-black_900 text-left w-[auto]"
                          variant="body91"
                        >
                          Privacy Policy
                        </Text>
                        <div className="flex items-start justify-start pl-[3px] pr-[2.34px] w-[auto]">
                          <Text
                            ...
                            variant="body91"
                          >
                            <span className="text-black_900 text-[11px] font-inter">
                              /{" "}
                            </span>
                            <span className="text-black_900 text-[11px] font-inter capitalize">
                              Terms of Use
                            </span>
                          </Text>
                        </div>
                ...
                >
                  <div className="flex flex-col gap-[19px] items-start justify-end mb-[29px] sm:ml-[0] pt-[15px] px-[15px] w-[100%]">
                    <Text
                      className="font-normal mt-[4px] not-italic text-black_900 text-left tracking-[0.20px] w-[auto]"
                      variant="body68"
                    >
                      About Zola
                    </Text>
                    <div className="flex flex-col items-start justify-start pr-[2px] py-[2px] md:w-[100%] w-[auto]">
                      <Text
                        className="capitalize font-normal not-italic text-black_900 text-left w-[auto]"
                        variant="body91"
                      >
                        Our Story
                      </Text>
                      <Text
                        className="capitalize font-normal mt-[14px] not-italic text-black_900 text-left w-[auto]"
                        variant="body98"
                      >
                        Press
                      </Text>
                      <Text
                        className="capitalize font-normal mt-[15px] not-italic text-black_900 text-left w-[auto]"
                        variant="body91"
                      >
                        Jobs
                      </Text>
                      <Text
                        className="capitalize font-normal mt-[16px] not-italic text-black_900 text-left w-[auto]"
                        variant="body91"
                      >
                        Wedding Vendors
                      </Text>
                      <Text
                        className="capitalize font-normal mt-[13px] not-italic text-black_900 text-left w-[auto]"
                        variant="body91"
                      >
                        Refer a Friend
                      </Text>
                      <Text
                        className="capitalize font-normal mb-[12px] mt-[15px] not-italic text-black_900 text-left w-[auto]"
                        variant="body91"
                      >
                        Zola Reviews
                      </Text>
                  ...
                  <div className="flex flex-col gap-[17px] items-start justify-end sm:ml-[0] pt-[15px] px-[15px] w-[100%]">
                    <Text
                      className="font-normal mt-[6px] not-italic text-black_900 text-left tracking-[0.20px] w-[auto]"
                      variant="body68"
                    >
                      Help
                    </Text>
                    <div className="flex flex-col items-start justify-start pr-[2px] py-[2px] md:w-[100%] w-[auto]">
                      ...
                      <Text
                        className="capitalize font-normal my-[13px] not-italic text-black_900 text-left w-[auto]"
                        variant="body91"
                      >
                        Contact Us
                      </Text>
                ...
                <div className="flex md:flex-1 flex-col gap-[17px] items-center justify-end p-[6px] md:w-[100%] w-[25%]">
                  <Text
                    className="font-normal mt-[14px] not-italic text-black_900 text-left tracking-[0.20px] w-[auto]"
                    variant="body68"
                  >
...
export default WwwzolacombyhtmltodesignFREEversion01032023OnePage;
